...
def mutation_plotter(df, xdata, ydata, style='darkgrid'):
    ...
    p = sns.lmplot(
        ...
        height=10, aspect=1, palette=cdict, scatter_kws={'alpha': 0.5, 's': 150, 'linewidth': 2},
        line_kws={"alpha": 0.5, "lw": 3, 'linestyle': '--'},
        markers=['o', 'x', '+', 's', 'v', '^', 'd' ],
        legend=False
    )
    ...
    # plt.xlim(2002, 2022)
    # plt.ylim(0,)
    plt.xticks([2002, 2004, 2006, 2008, 2010, 2012, 2014, 2016, 2018, 2020, 2022], fontsize=14)
